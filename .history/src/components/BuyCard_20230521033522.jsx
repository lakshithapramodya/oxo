...
export default function BuyCard() {
  return (
    <div className="mt-28 lg:flex lg:items-center lg:relative lg:h-[450px]">
      <div className="mx-auto md:mx-0 lg:w-[45%]">
      ...
      <img
        className="mt-8 ml-auto absolute inset-y-0 right-0"
