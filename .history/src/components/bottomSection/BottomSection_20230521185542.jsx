...
import FeaturesLargeCard from "./components/FeaturesLargeCard";
import QuestionsLargeCard from "./components/QuestionsLargeCard";

// Data for the features card
const featuresData = [
  {
    id: 1,
...
export default function BottomSection() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="max-w-full sm:max-w-[75%] lg:max-w-[85%] 2xl:max-w-[75%] mx-auto px-6 lg:px-0 mt-[800px] sm:mt-[600px] md:mt-[520px] lg:mt-[500px] xl:mt-[100px]">
        <QuestionsLargeCard />
      </div>
    </div>
  );
