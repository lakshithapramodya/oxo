...
const featuresData = [
  {
    ...
    icon: <FaShoppingBag color="#ffffff" size="45px" />,
    iconBg: "bg-[#6600f2]",
  },
  {
    id: 2,
    ...
    description:
      "Inspiration comes in many ways and you like to save everything from. sed do eiusmod tempor incididunt ut labore et dolor.",
    icon: <FaShoppingCart color="#ffffff" size="45px" />,
    iconBg: "bg-[#fb3c7f]",
  },
  {
    id: 3,
    ...
    description:
      "Inspiration comes in many ways and you like to save everything from. sed do eiusmod tempor incididunt ut labore et dolor.",
    icon: <IoDocumentTextOutline color="#ffffff" size="45px" />,
    iconBg: "bg-[#00d280]",
  },
  {
    id: 4,
    ...
    description:
      "Inspiration comes in many ways and you like to save everything from. sed do eiusmod tempor incididunt ut labore et dolor.",
    icon: <FaTag color="#ffffff" size="45px" />,
    iconBg: "bg-[#fbab2f]",
  },
];
