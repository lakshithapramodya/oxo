...
export default function BottomSection() {
  return (
    <div className="bg-gradient-to-l from-[#dc61fe] to-[#7049c4] mt-16 h-[530px]">
      <div className="max-w-[95%] sm:max-w-[75%] mx-auto px-6">
        <div className="pt-24">
          <h2 className="text-white text-5xl md:text-5xl font-semibold text-center leading-[4rem]">
